...
#number of layers as the structure defined in this present script
...
prop_sim["angles"]=np.linspace(1,10,10)#incident angles in degrees
...
R,output1,output2,bkg1,bkg2=XRMS_Simulation_Load.Sample2Reflection_Coefficients(sample_crystal, simulation_input)
