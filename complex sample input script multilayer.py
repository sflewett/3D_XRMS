...
prop_3D['Mx']="Mx_Matlab.csv"#micromagnetic simulation inputs
prop_3D['My']="My_Matlab.csv"#don´t forget to put these files in the working directory, or add the path to the filename
prop_3D['Mz']="Mz_Matlab.csv"
