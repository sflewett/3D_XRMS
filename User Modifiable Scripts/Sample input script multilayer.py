...
prop_sim["orders_x"]=15
prop_sim["orders_y"]=15
...
prop_3D['Mx']="../Magnetization Files/Mx_LSMO.csv"#micromagnetic simulation inputs
prop_3D['My']="../Magnetization Files/My_LSMO.csv"#don´t forget to put these files in the working directory, or add the path to the filename
prop_3D['Mz']="../Magnetization Files/Mz_LSMO.csv"
